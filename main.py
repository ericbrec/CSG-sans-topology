...
print(triangleA.VolumeIntegral(lambda x, n: n), 0.5)
...
print(squareA.VolumeIntegral(lambda x, n: n), 4.0*4.0)
...
print(squareB.VolumeIntegral(lambda x, n: n), 3.0*3.0)
...
print(starA.VolumeIntegral(lambda x, n: n), starArea * 4.0)
...
print(starB.VolumeIntegral(lambda x, n: n), starArea)
