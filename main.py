...
print(triangleA.ContainsPoint(np.array([.75,.75])))
print(triangleA.ContainsPoint(np.array([.5,.5])))
print(triangleA.ContainsPoint(np.array([.25,.25])))
...
print(squareA.ContainsPoint(np.array([0.,0.])))
...
print(starA.ContainsPoint(np.array([-1.,-1.])))
